...
class CooktopServiceClient extends $rpc.ServiceClient {
  ...
  static final _$restartConnectivityModule = $rpc.Method<
      $0.RestartConnectivityModuleRequest,
      $0.RestartConnectivityModuleResponse>(
    '/bora.generic.cooktop.v1.CooktopService/RestartConnectivityModule',
    (req) => req.writeToBuffer(),
    (res) => $0.RestartConnectivityModuleResponse.fromBuffer(res),
    false,
    false,
  );
  ...
  $rpc.ResponseFuture<$0.RestartConnectivityModuleResponse>
      restartConnectivityModule($0.RestartConnectivityModuleRequest request,
          [$rpc.RequestOptions? options]) {
    return $createCall(_$restartConnectivityModule, request, options);
  }
}
