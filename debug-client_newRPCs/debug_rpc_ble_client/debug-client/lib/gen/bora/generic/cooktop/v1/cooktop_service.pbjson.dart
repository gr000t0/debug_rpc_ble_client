...
@$core.Deprecated('Use restartConnectivityModuleRequestDescriptor instead')
const RestartConnectivityModuleRequest$json = const {
  '1': 'RestartConnectivityModuleRequest',
};

/// Descriptor for `RestartConnectivityModuleRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List restartConnectivityModuleRequestDescriptor = $convert.base64Decode('CiBSZXN0YXJ0Q29ubmVjdGl2aXR5TW9kdWxlUmVxdWVzdA==');
@$core.Deprecated('Use restartConnectivityModuleResponseDescriptor instead')
const RestartConnectivityModuleResponse$json = const {
  '1': 'RestartConnectivityModuleResponse',
};

/// Descriptor for `RestartConnectivityModuleResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List restartConnectivityModuleResponseDescriptor = $convert.base64Decode('CiFSZXN0YXJ0Q29ubmVjdGl2aXR5TW9kdWxlUmVzcG9uc2U=');
const $core.Map<$core.String, $core.dynamic> CooktopServiceBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'RestartConnectivityModule', '2': '.bora.generic.cooktop.v1.RestartConnectivityModuleRequest', '3': '.bora.generic.cooktop.v1.RestartConnectivityModuleResponse'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> CooktopServiceBase$messageJson = const {
  ...
  '.bora.generic.cooktop.v1.RestartConnectivityModuleRequest': RestartConnectivityModuleRequest$json,
  '.bora.generic.cooktop.v1.RestartConnectivityModuleResponse': RestartConnectivityModuleResponse$json,
};

/// Descriptor for `CooktopService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List cooktopServiceDescriptor = $convert.base64Decode('');
