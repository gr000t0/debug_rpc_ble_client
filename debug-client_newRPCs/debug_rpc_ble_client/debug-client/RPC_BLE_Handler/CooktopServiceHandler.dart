...
class CooktopServiceHandler {
  ...
  Future<void> restartConnectivityModule() async {
    var response = await client.restartConnectivityModule(RestartConnectivityModuleRequest(), RequestOptions(headers: {}));
    print(response.toString());
  }
...
Future<void> callMethod(String methodName) async {
  ...
  switch (word[0]) {
    ...
    case 'setSpecificCooktopSetting':
      ...
      break;
    case 'restartConnectivityModule':
      await restartConnectivityModule();
      break;
    case 'help':
