...
class ZoneServiceHandler {
  ...
  Future<void> getZoneStatusAll() async {
    var response = await client.getZoneStatus(GetZoneStatusRequest(uId: 'front_left'), RequestOptions(headers: {}));
    print("Zone Status front_left: ${response.toString()}");
    response = await client.getZoneStatus(GetZoneStatusRequest(uId: 'front_right'), RequestOptions(headers: {}));
    print("Zone Status front_right: ${response.toString()}");
    response = await client.getZoneStatus(GetZoneStatusRequest(uId: 'back_left'), RequestOptions(headers: {}));
    print("Zone Status back_left: ${response.toString()}");
    response = await client.getZoneStatus(GetZoneStatusRequest(uId: 'back_right'), RequestOptions(headers: {}));
    print("Zone Status back_right: ${response.toString()}");
  }
  ...
  Future<void> callMethod(String methodName) async {
    ...
    switch (parts[0]) {
      ...
      case 'getZoneStatus':
        ...
        break;
      case 'getZoneStatusAll':
        await getZoneStatusAll();
        break;
