...
const ErrorCode$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ERROR_CODE_E_8_LEFT_FRONT', '2': 7},
    const {'1': 'ERROR_CODE_E_9_LEFT_FRONT', '2': 8},
    const {'1': 'ERROR_CODE_E_A_LEFT_FRONT', '2': 9},
    const {'1': 'ERROR_CODE_H_LEFT_FRONT', '2': 10},
    const {'1': 'ERROR_CODE_E_1_LEFT_BACK', '2': 11},
    const {'1': 'ERROR_CODE_E_2_LEFT_BACK', '2': 12},
    const {'1': 'ERROR_CODE_E_3_LEFT_BACK', '2': 13},
    const {'1': 'ERROR_CODE_E_4_LEFT_BACK', '2': 14},
    const {'1': 'ERROR_CODE_E_5_LEFT_BACK', '2': 15},
    const {'1': 'ERROR_CODE_E_6_LEFT_BACK', '2': 16},
    const {'1': 'ERROR_CODE_E_8_LEFT_BACK', '2': 17},
    const {'1': 'ERROR_CODE_E_9_LEFT_BACK', '2': 18},
    const {'1': 'ERROR_CODE_E_A_LEFT_BACK', '2': 19},
    const {'1': 'ERROR_CODE_H_LEFT_BACK', '2': 20},
    const {'1': 'ERROR_CODE_E_1_RIGHT_BACK', '2': 21},
    const {'1': 'ERROR_CODE_E_2_RIGHT_BACK', '2': 22},
    const {'1': 'ERROR_CODE_E_3_RIGHT_BACK', '2': 23},
    const {'1': 'ERROR_CODE_E_4_RIGHT_BACK', '2': 24},
    const {'1': 'ERROR_CODE_E_5_RIGHT_BACK', '2': 25},
    const {'1': 'ERROR_CODE_E_6_RIGHT_BACK', '2': 26},
    const {'1': 'ERROR_CODE_E_8_RIGHT_BACK', '2': 27},
    const {'1': 'ERROR_CODE_E_9_RIGHT_BACK', '2': 28},
    const {'1': 'ERROR_CODE_E_A_RIGHT_BACK', '2': 29},
    const {'1': 'ERROR_CODE_H_RIGHT_BACK', '2': 30},
    const {'1': 'ERROR_CODE_E_1_RIGHT_FRONT', '2': 31},
    const {'1': 'ERROR_CODE_E_2_RIGHT_FRONT', '2': 32},
    const {'1': 'ERROR_CODE_E_3_RIGHT_FRONT', '2': 33},
    const {'1': 'ERROR_CODE_E_4_RIGHT_FRONT', '2': 34},
    const {'1': 'ERROR_CODE_E_5_RIGHT_FRONT', '2': 35},
    const {'1': 'ERROR_CODE_E_6_RIGHT_FRONT', '2': 36},
    const {'1': 'ERROR_CODE_E_8_RIGHT_FRONT', '2': 37},
    const {'1': 'ERROR_CODE_E_9_RIGHT_FRONT', '2': 38},
    const {'1': 'ERROR_CODE_E_A_RIGHT_FRONT', '2': 39},
    const {'1': 'ERROR_CODE_H_RIGHT_FRONT', '2': 40},
    const {'1': 'ERROR_CODE_E_03', '2': 41},
    const {'1': 'ERROR_CODE_E_07', '2': 42},
    const {'1': 'ERROR_CODE_E_13', '2': 43},
    const {'1': 'ERROR_CODE_E_21', '2': 44},
    const {'1': 'ERROR_CODE_E_22', '2': 45},
    const {'1': 'ERROR_CODE_E_35', '2': 46},
    const {'1': 'ERROR_CODE_E_47', '2': 47},
    const {'1': 'ERROR_CODE_E_58', '2': 48},
    const {'1': 'ERROR_CODE_E_95', '2': 49},
    const {'1': 'ERROR_CODE_E_96', '2': 50},
    const {'1': 'ERROR_CODE_E_97', '2': 51},
    const {'1': 'ERROR_CODE_E_98', '2': 52},
    const {'1': 'ERROR_CODE_E_99', '2': 53},
    const {'1': 'ERROR_CODE_U_400', '2': 54},
    const {'1': 'ERROR_CODE_E_B', '2': 55},
    const {'1': 'ERROR_CODE_E_C', '2': 56},
    const {'1': 'ERROR_CODE_E_D', '2': 57},
    const {'1': 'ERROR_CODE_E_E', '2': 58},
  ],
};

/// Descriptor for `ErrorCode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List errorCodeDescriptor = $convert.base64Decode('');
